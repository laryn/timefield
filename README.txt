...
Timefield is a Field API field that stores a time value, with an optional to 
time.  The values are stored in the database as integer offsets from 12AM.  
If the second value continues into the next day, i.e. 8PM - 2AM, the second 
value is stored as an offset +1 day.

The real goal of this field is to provide a taxonomy capable of encapsulating 
